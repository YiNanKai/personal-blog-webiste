...
CREATE TABLE IF NOT EXISTS `website`.`user_analyze_information` (
  ...
  `user_analyze_information_register_time` DATETIME NOT NULL COMMENT '用户注册时间',
...
CREATE TABLE IF NOT EXISTS `website`.`message` (
  `message` INT NOT NULL AUTO_INCREMENT COMMENT '自增id',
