											...
											for (var i = 0; i < size; i++) {
												...
												str = '<div class="item"> '
													...
													for (var i = 0; i < pics.length; i++){
														str += '<li><a rev="group1" rel="zoomHeight:200, zoomWidth:400, adjustX: 10, adjustY:-4, position:\'body\'" class="cloud-zoom" href="images/sanguoshapicture/' + pics[i] + '"><img src="images/thumbs/sanguoshapicture/' + pics[i] + '" alt="Formstack 1" /></a></li> '			
													}
...
//////////////////////////////s///////////////////////////
						 ...
						 */
						$('body').on('click', '#content .mousetrap', function() {
						 ...
						 */
						var $content = $('#content'), $thumb_list = $content
								.find('.thumb > ul');
						/*
																	...
																	if (loaded == total_images) {
																		...
																		$this_list
																				...
																				.bind(
																						...
																						function(
																								e) {
																							var current = $this_list
																									.data('current');
																							if (current == $this_list
																									.children().length - 1)
																								return false;
																							var next = ++current, ml = -next
																									* $this_list
																											.children(
																													':first')
																											.width();
